...
export const fr: Catalog = {
  ...
  'value.progressBytes': '{received} sur {total}',
  'value.progressFiles': 'Fichier {done} sur {total}',
  ...
  'toast.downloadResumed': 'Téléchargement repris',
  'toast.downloadRequeued': 'De retour dans la file',
  ...
  'status.dialogTitle': 'Où en êtes-vous ?',
  'status.none': 'Non précisé',
  'status.incomplete': 'En cours',
  'status.finished': 'Terminé',
  'status.completed_100': 'Terminé à 100 %',
  'status.retired': 'Abandonné',
  'status.never_playing': 'Pas pour moi',
  'status.set': 'Marqué « {status} »',
  'status.cleared': 'Progression effacée',
  ...
  'downloads.state.stalled': 'En attente de RomM',
  'downloads.state.queued': 'En attente',
  'downloads.state.downloading': 'Téléchargement',
  'downloads.state.checking': 'Vérification',
  'downloads.state.extracting': 'Extraction',
  'downloads.state.installing': 'Installation',
  ...
  'uninstall.body': 'Le jeu sera supprimé de {folder}. Vos sauvegardes sur RomM sont conservées.',
  ...
  'bios.groupMeta_one': '{installed} sur {count} fichier en place',
  'bios.groupMeta_other': '{installed} sur {count} fichiers en place',
  ...
  'bios.note.jaguarCd': 'ROM d’amorçage Jaguar CD — remplace celle du cœur',
  ...
  'bios.note.x1Ipl': 'ROM IPL Sharp X1',
  ...
  'bios.note.vircon32Bios': 'BIOS Vircon32 — remplace celui fourni par le cœur',
  ...
  'bios.setup.x1': 'Le cœur X1 lit sa ROM IPL dans un dossier xmil placé dans le dossier BIOS.',
  'bios.setup.x68000':
  ...
  'game.resumeDownload': 'Reprendre le téléchargement ({percent} %)',
  'game.pauseDownload': 'Mettre en pause ({percent} %)',
  ...
  'game.tabManual': 'Manuel',
  'game.tabAchievements': 'Succès',
  ...
  'game.downloadQueued': 'Ajouté à la file',
  ...
  'game.deleteSaveTitle': 'Supprimer cette sauvegarde ?',
  'game.deleteStateTitle': 'Supprimer cet état ?',
  ...
  'manual.previous': 'Page précédente',
  ...
  'achievements.earnedIn':
    'Les succès s’obtiennent dans {emulator}, qui doit être connecté à RetroAchievements.',
  'achievements.earnedInEmulator':
    'Les succès s’obtiennent dans l’émulateur, qui doit être connecté à RetroAchievements.',
  ...
  'settings.dateFormatHint':
    'Comment chaque date est écrite — {example}. L’heure est toujours sur 24 heures.',
  'settings.date.dmy': 'Jour en premier',
  ...
  'settings.themeBody': 'L’écran derrière est dessiné dans le thème sous le curseur.',
  'settings.themeCurrent': 'Utilisée',
  'settings.theme.midnight': 'Minuit',
  'settings.theme.daylight': 'Plein jour',
  'settings.theme.lamplight': 'À la lampe',
  'settings.theme.atari': 'Atari 2600',
  'settings.theme.c64': 'Commodore 64',
  'settings.theme.spectrum': 'ZX Spectrum',
  'settings.theme.famicom': 'Famicom',
  'settings.theme.macintosh': 'Macintosh',
  'settings.theme.amiga': 'Amiga',
  'settings.theme.megadrive': 'Mega Drive',
  'settings.theme.gameboy': 'Game Boy',
  'settings.theme.superfamicom': 'Super Famicom',
  'settings.theme.virtualboy': 'Virtual Boy',
  'settings.theme.dreamcast': 'Dreamcast',
  'settings.theme.vmu': 'VMU',
  'settings.theme.gamecube': 'GameCube',
  ...
  'error.savesNotFetched_one': '{count} sauvegarde n’a pas pu être récupérée depuis RomM.',
  'error.savesNotFetched_other': '{count} sauvegardes n’ont pas pu être récupérées depuis RomM.',
  ...
  'error.emptyArchive': '{name} est arrivé sous la forme d’une archive vide.',
  ...
  'launch.emulatorCrashed': 'L’émulateur a été tué en cours de partie ({signal}).',
  ...
  'launch.quitImmediatelySignal': 'L’émulateur a été tué immédiatement ({signal}).',
