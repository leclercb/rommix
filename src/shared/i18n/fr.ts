...
export const fr: Catalog = {
  ...
  'files.onServer': 'Sur le serveur',
  'files.onDevice': 'Sur cet appareil',
  'files.serverEmpty': 'RomM ne liste aucun fichier pour ce jeu.',
  'files.notDownloaded': 'Non téléchargé.',
