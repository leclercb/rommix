...
export const es: Catalog = {
  ...
  'game.deleteSaveTitle': '¿Borrar esta partida {where}?',
  'game.deleteStateTitle': '¿Borrar este estado {where}?',
  ...
  'saves.consequenceLocal': 'Traer las partidas devolverá aquí la copia de RomM.',
  'saves.consequenceRemote': 'Enviar las partidas subirá de nuevo la copia de este dispositivo.',
