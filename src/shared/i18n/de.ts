...
export const de: Catalog = {
  ...
  'value.progressFiles': 'Datei {done} von {total}',
  ...
  'library.scopeLabel': 'Anzeigen:',
  'library.searchLabel': 'Suche:',
  'library.platformLabel': 'Plattform:',
  'library.scopeAll': 'Alle Spiele',
  'library.scopeDownloaded': 'Nur heruntergeladene',
  ...
  'status.button': 'Fortschritt',
  'status.dialogTitle': 'Wie weit sind Sie?',
  'status.none': 'Nicht angegeben',
  'status.incomplete': 'Wird gespielt',
  'status.finished': 'Durchgespielt',
  'status.completed_100': 'Vollständig abgeschlossen',
  'status.retired': 'Aufgegeben',
  'status.never_playing': 'Nichts für mich',
  'status.set': 'Als „{status}“ markiert',
  'status.cleared': 'Fortschritt gelöscht',
  ...
  'downloads.state.stalled': 'Wartet auf RomM',
  'downloads.state.queued': 'Wartet',
  'downloads.state.downloading': 'Lädt herunter',
  'downloads.state.checking': 'Wird geprüft',
  'downloads.state.extracting': 'Entpackt',
  'downloads.state.installing': 'Wird installiert',
  ...
  'game.play': 'Spielen',
  'game.running': 'Läuft…',
  'game.resumeDownload': 'Download fortsetzen ({percent} %)',
  'game.pauseDownload': 'Download pausieren ({percent} %)',
  ...
  'game.deleteSaveTitle': 'Diesen Spielstand löschen?',
  'game.deleteStateTitle': 'Diesen Savestate löschen?',
  ...
  'files.tagDevice': 'Gerät',
  'files.hintBoth': 'Auf dem Server und auf diesem Gerät.',
  'files.hintServer': 'Nur auf dem Server. Laden Sie das Spiel herunter, um sie zu bekommen.',
  'files.hintDevice': 'Nur auf diesem Gerät. RomM führt sie nicht.',
  'files.empty':
  ...
  'achievements.earnedIn':
    'Erfolge werden in {emulator} erreicht, das bei RetroAchievements angemeldet sein muss.',
  'achievements.earnedInEmulator':
    'Erfolge werden im Emulator erreicht, der bei RetroAchievements angemeldet sein muss.',
  ...
  'settings.theme.lamplight': 'Lampenlicht',
  ...
  'error.savesNotFetched_one': '{count} Spielstand konnte nicht von RomM geladen werden.',
  'error.savesNotFetched_other': '{count} Spielstände konnten nicht von RomM geladen werden.',
  ...
  'error.emptyArchive': '{name} kam als Archiv ohne Inhalt an.',
  ...
  'launch.emulatorCrashed': 'Der Emulator wurde mittendrin beendet ({signal}).',
  ...
  'launch.quitImmediatelySignal': 'Der Emulator wurde sofort beendet ({signal}).',
