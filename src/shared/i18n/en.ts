...
export const en = {
  ...
  'toast.downloadRequeued': 'Back in the queue',
  ...
  'downloads.state.stalled': 'Waiting for RomM',
  ...
  'downloads.state.installing': 'Installing',
  ...
  'game.resumeDownload': 'Resume download ({percent}%)',
  'game.pauseDownload': 'Pause download ({percent}%)',
  ...
  'game.downloadQueued': 'Added to the queue',
  ...
  'game.deleteSaveTitle': 'Delete this save?',
  'game.deleteStateTitle': 'Delete this state?',
  ...
  'settings.theme.lamplight': 'Lamplight',
  ...
  'error.savesNotFetched_one': '{count} save could not be fetched from RomM.',
  'error.savesNotFetched_other': '{count} saves could not be fetched from RomM.',
  ...
  'error.emptyArchive': '{name} arrived as an archive with nothing in it.',
  ...
  'launch.emulatorCrashed': 'The emulator was killed part-way through ({signal}).',
  ...
  'launch.quitImmediatelySignal': 'The emulator was killed immediately ({signal}).',
