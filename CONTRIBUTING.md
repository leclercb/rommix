...
Twelve attributes exist for `npm run test:app` and nothing else: `data-screen`
...
thumbnail, and `data-action` on a `FocusButton` that a scenario presses. They are there because
