/**
 * Putting packaging/rommix-launcher.sh in front of the Electron binary.
 *
 ...
 * it to exec in turn. See packaging/rommix-launcher.sh for what it decides.
 *
...
const LAUNCHER = join(import.meta.dirname, '..', 'packaging', 'rommix-launcher.sh')
